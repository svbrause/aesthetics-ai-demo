...
export default function SimpleColorExperimentPage() {
  ...
  const patient = {
    ...
    findings: [
      ...
      { name: "Upper Eye Hollow", severity: "mild" as const, score: 62 },
      { name: "Lower Eyelid Sag", severity: "moderate" as const, score: 65 },
      {
      ...
      { name: "Masseter Hypertrophy", severity: "mild" as const, score: 58 },
    ],
  ...
  return (
    ...
    >
      ...
      <div
        className="fixed top-4 left-4 z-50 px-4 py-2 rounded-lg text-sm font-medium shadow-sm"
        style={{
      ...
      {/* Apply grayscale design with proper contrast and hierarchy */}
      <style
