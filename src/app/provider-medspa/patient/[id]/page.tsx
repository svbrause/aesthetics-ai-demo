...
import { PatientDetailScreenV2RefactoredMedspa } from "@/components/provider/PatientDetailScreenV2RefactoredMedspa";
...
export default function ProviderMedspaPatientPage() {
  ...
  return (
    <div className="medspa-theme">
      <PatientDetailScreenV2RefactoredMedspa
        patient={mockPatient}
        onBack={handleBack}
