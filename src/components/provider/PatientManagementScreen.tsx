        ...
        <div className="flex space-x-4" data-tutorial="patients-search">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <select
            ...
            className="px-4 py-2 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            style={{ backgroundColor: "#f3f4f6" }}
          >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-900">Dr. Smith</p>
                          <p className="text-sm text-gray-700">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {patient.treatments.map(
                            (treatment, treatmentIndex) => (
                              <span
                                key={treatmentIndex}
                                className="px-2 py-1 text-white text-xs rounded border border-transparent"
                                style={{ backgroundColor: "#367588" }}
                              >
                                {treatment}
                              </span>
