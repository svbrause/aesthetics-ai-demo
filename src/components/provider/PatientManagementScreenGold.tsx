...
interface PatientManagementScreenGoldProps {
  onSelectPatient: (patient: any) => void;
  onBack: () => void;
}

export function PatientManagementScreenGold({
  onSelectPatient,
  onBack,
}: PatientManagementScreenGoldProps) {
  ...
  return (
    <div
      className="bg-gradient-to-br from-black via-gray-900 to-black flex flex-col h-screen overflow-hidden gold-theme"
        ...
        <div className="flex space-x-4" data-tutorial="patients-search">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-gray-800/50 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
            />
          </div>
          <select
            value={filterStatus}
            onChange={(e) => setFilterStatus(e.target.value)}
            className="px-4 py-2 bg-gray-800/50 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
          >
                        ...
                        <div className="flex flex-wrap gap-1">
                          {patient.treatments.map(
                            (treatment, treatmentIndex) => (
                              <span
                                key={treatmentIndex}
                                className="px-2 py-1 bg-yellow-600/20 text-yellow-300 text-xs rounded border border-yellow-500/30"
                              >
                                {treatment}
                              </span>
                            )
