...
export function PatientDetailScreenV2Refactored({
  ...
  return (
    <div
      className="bg-medspa-bg flex flex-col h-screen overflow-hidden relative patient-detail-container medspa-new-theme"
          ...
          >
            ...
            <div className="absolute top-4 right-4 flex space-x-2 z-10">
              <Button
                size="sm"
                variant="ghost"
                className="text-medspa-text-secondary hover:text-medspa-text-primary hover:bg-medspa-accent-24"
                ...
                >
                  {[
                    ...
                    <Button
                      ...
                      style={{
                        backgroundColor:
                          currentView === view.id ? "#367588" : "#f3f5f6",
                        borderColor:
                          currentView === view.id ? "#367588" : "#E5E7EB",
                        borderWidth: "1px",
                        borderStyle: "solid",
                      }}
                    >
